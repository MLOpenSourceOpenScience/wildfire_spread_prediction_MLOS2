...
import yaml
from firecast.model import FireCast
from firecast.dataset import WildFireData
...
def parse_args():
    ...
    parser.add_argument('--config', dest='config', default='firecast/configs/config.yaml')
